...
#
#built from malfind, this is a sumary of what malfind will find. it does not display bytes just PID and Process name.
import logging
...
#                           file_output, format_hints.HexBytes(data), disasm))
    ...
    def run(self):
        ...
        return renderers.TreeGrid([("PurpleID", int), ("Process", str), ("Start VPN", format_hints.Hex),
                                   ("End VPN", format_hints.Hex)],

#removed
##                                ("Tag", str), ("Protection", str),
